...
import { getOrderDetails } from "@/services/adminOrder";
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <p><span className="font-semibold">Processing:</span> 
                <span className={`ml-2 ${order.isProcessing ? 'text-yellow-600' : 'text-green-600'}`}>
                  {order.isProcessing ? 'In Progress' : 'Completed'}
                </span>
              </p>
            </div>
            <div>
