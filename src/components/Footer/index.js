...
const Footer = () => {
  ...
  return (
    <footer
      ...
      } border-t-2 border-primary/20 p-10 shadow-lg transition-all duration-300 hover:border-primary/60 hover:shadow-[0_0_15px_rgba(0,173,181,0.3)] ${
        mounted && isDark ? "text-textDark dark" : "text-text"
      }`}
    >
      <div className="footer mx-auto max-w-7xl">
        <nav>
          <h6
            className={`footer-title ${mounted && isDark ? "text-textDark/80" : "text-text/80"}`}
          >
            Company
          </h6>
          <Link
        ...
        <nav>
          ...
          <div className="grid grid-flow-col gap-4">
            <a
              ...
              className={`${mounted && isDark ? "text-textDark hover:text-primary" : "text-text hover:text-primary"} transition-colors duration-300`}
            >
              <svg
